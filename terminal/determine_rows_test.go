...
func TestDetermineRows(t *testing.T) {
	...
	trials := []struct {
		...
		},
		{
			...
			previousPosition: 12,
			previousValue:    "",
			expectedRow:      []string{"small string"},
			expectedCursor:   1,
			expectedOffset:   0,
		},
		{
			...
			previousPosition: 0,
			previousValue:    "",
			expectedRow:      []string{"small: 0123456789012", "34567890"},
			expectedCursor:   1,
			expectedOffset:   7,
		},
		{
		...
		},
		{
			...
			expectedRow:      []string{"small: hello world", ""},
			expectedCursor:   2,
			expectedOffset:   0,
		},
		{
			...
			previousPosition: 0,
			previousValue:    "",
			expectedRow:      []string{"small: hello", "world", "check", "me"},
			expectedCursor:   1,
			expectedOffset:   7,
		},
		{
